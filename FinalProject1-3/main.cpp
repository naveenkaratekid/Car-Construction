...
int main(void)
{
    ...
    else if(exteriorCarMaterial == "steel" || exteriorCarMaterial == "Steel")
    {
        exteriorCarMaterial = "Steel";
    }
    else if(exteriorCarMaterial == "iron" || exteriorCarMaterial == "Iron")
    {
        exteriorCarMaterial = "Iron";
    }
    else
    {
